  ...
  <div className="prjDiv">
    <img src="./images/nodeJsIcon.png" alt="icon1" className="prjIcons"/>
       ...
       <div className='app-links'>
          <a href={project.url} target='_blank' rel='noreferrer'><span style={{position:'relative',left:-4,top:-8}}>Live</span>
            <i className='ri-links-line'></i>
          </a>
          <a href={project.frontCode} target='_blank' rel='noreferrer'><span  style={{position:'relative',left:-2,top:-8}}>Frontend</span>
            <i className='ri-github-line'></i>
          </a>
          <a href={project.backCode} target='_blank' rel='noreferrer'><span  style={{position:'relative',left:-2,top:-8}}>Backend</span>
            <i className='ri-github-line'></i>
          </a>
        </div>
      </div>
